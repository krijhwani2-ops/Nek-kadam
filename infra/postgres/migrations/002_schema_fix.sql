...
-- Ensure all columns exist across all existing tables
ALTER TABLE patients ADD COLUMN IF NOT EXISTS card_number TEXT;
ALTER TABLE patients ADD COLUMN IF NOT EXISTS identifier TEXT;
ALTER TABLE patients ADD COLUMN IF NOT EXISTS adhar_no TEXT;
ALTER TABLE patients ADD COLUMN IF NOT EXISTS photo TEXT;
ALTER TABLE visits ADD COLUMN IF NOT EXISTS doctor_name TEXT;
ALTER TABLE visits ADD COLUMN IF NOT EXISTS patient_id TEXT;
ALTER TABLE prescription_groups ADD COLUMN IF NOT EXISTS power TEXT;
ALTER TABLE prescription_groups ADD COLUMN IF NOT EXISTS dosage_code TEXT;
ALTER TABLE group_medicines ADD COLUMN IF NOT EXISTS group_id TEXT;
ALTER TABLE group_medicines ADD COLUMN IF NOT EXISTS medicine_code TEXT;
ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS "departmentId" TEXT;
ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS entity TEXT;
